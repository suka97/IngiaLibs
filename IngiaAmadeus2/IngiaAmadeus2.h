...
private:
    ...
    // Internal Methods    
    uint8_t _getOpcionesSize(char *str, char index);
    uint8_t _splitOpciones(char* str, char** buffer, uint8_t wordSize, char index);
...
public:
    ...
    IngiaAmadeus2( char **menus, long *valoresDefault, char **unids, long *valmin, long *valmax, int cantMenus, 
