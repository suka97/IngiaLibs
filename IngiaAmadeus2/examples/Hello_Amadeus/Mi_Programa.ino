...
void MiPrograma() {
    switch ( amadeus.menu("JOG,Loop Mov,Config") ) {
        ...
        default:
            ...
            amadeus.print("Se intento", 0, IngiaAmadeus2::LCD_CENTER, true);
            amadeus.print("salir", 1, IngiaAmadeus2::LCD_CENTER, false);
            delay(1500);
            break;
    }
}
...
void loopMov() {
    ...
    while(1) 
    {
        ...
        */
        ...
        // muestro un mensaje
        amadeus.print("Moviendo", 0, IngiaAmadeus2::LCD_CENTER, true);
        amadeus.print("para un", 1, IngiaAmadeus2::LCD_CENTER, false);
        amadeus.print("lado", 2, IngiaAmadeus2::LCD_CENTER, false);
        ...
        while( amadeus.stepper1.run() ) {
            ...
            if ( amadeus.encoder.isDoubleClicked() ) {
                amadeus.print("Cancelado", 1, IngiaAmadeus2::LCD_CENTER, true);
                delay(1500);
                return;
            }
        }
        ...
        amadeus.print("Esperando", 1, IngiaAmadeus2::LCD_CENTER, true);
        delay( amadeus.getVal(DELAY) );

        // muestro un mensaje
        amadeus.print("Moviendo", 0, IngiaAmadeus2::LCD_CENTER, true);
        amadeus.print("para el", 1, IngiaAmadeus2::LCD_CENTER, false);
        amadeus.print("otro", 2, IngiaAmadeus2::LCD_CENTER, false);
