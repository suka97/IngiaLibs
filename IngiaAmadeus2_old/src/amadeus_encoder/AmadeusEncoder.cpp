...
//
#define ENC_ACCEL_TOP       0x3F00   // max. acceleration: *12 (val >> 8)
#define ENC_ACCEL_INC       25
#define ENC_ACCEL_DEC       2

// ----------------------------------------------------------------------------

AmadeusEncoder::AmadeusEncoder(uint8_t A, uint8_t B, uint8_t BTN, uint8_t stepsPerNotch, bool active) : 
...
void AmadeusEncoder::service(void)
{
  bool moved = false;
...
int16_t AmadeusEncoder::getValue(void) {
  int16_t val;
